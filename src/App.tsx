...
const LINKS = [
  {
    category: "Highlights",
    items: [
      { name: "YouTube | 7.41K+ Subscribers", url: "https://youtube.com/@uzaylul", icon: Youtube, color: "hover:border-red-500/50" },
      ...
      { name: "TikTok | 36.9K+ Likes", url: "https://tiktok.com/@uzaylul", icon: Music2, color: "hover:border-white/50" },
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Roblox Group | 1.1K+ Members", url: "https://roblox.com/communities/8649115/uzaylul#!/store", icon: ShoppingBag, color: "hover:border-blue-500/50" },
    ]
  },
  {
    category: "Socials & Others",
    items: [
      { name: "Twitch | 5.7K+ Followers", url: "https://twitch.tv/uzaylul", icon: Twitch, color: "hover:border-purple-500/50" },
  ...
  },
  {
    ...
    items: [
      { name: "Roblox | 3.1K+ Followers", url: "https://roblox.com/users/122482369", icon: Gamepad2, color: "hover:border-white/50" },
    ...
    <div className="min-h-screen bg-[#0a0a0a] text-white font-sans selection:bg-white/10 selection:text-white">
      ...
      <main className="max-w-2xl mx-auto px-6 py-16 md:py-24">
        ...
        <header className="flex flex-col items-center text-center mb-16">
          ...
          >
            You can access all my social media and gaming accounts from the tabs below.
          </motion.p>
                ...
                >
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      ...
                      <span className="font-bold text-sm tracking-wide">{item.game} Crosshair</span>
                    </div>
